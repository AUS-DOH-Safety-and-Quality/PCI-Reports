...
If you don't have real data, generate demo data:
...
By using the code, most maps are already avialable. You may only need to run this when new hospitals appear in the dataset.
...
2.  **Load Data**: Read indicator summary from `_files/cardiac_indicators_summary.xlsx`
...
5.  **Save Output**: Export to `outputs/posters/<hospital>_pci_poster.pptx`
