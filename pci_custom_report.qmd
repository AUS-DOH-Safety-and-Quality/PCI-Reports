...
# add_new_pci_complete, indication_risk_factors_complete, activation_prehospital_sja_complete, activation_by_pci_centre_ed_complete, activation_by_nonpci_centre_ed_iht_complete, activation_by_other_hospital_ward_at_pci_centre_complete, activation_by_other_hospital_ward_at_pci_centre_complete, rescue_pci_complete, pci_details_complete, lesion_1_complete, lesion_2_complete, lesion_3_complete, lesion_4_complete, lesion_5_complete, discharge_data_complete, day_data_complete
# Plotting the distribution of Procedures by completeness
completeness <- pci_data |>
  dplyr::select(add_new_pci_complete, indication_risk_factors_complete, activation_prehospital_sja_complete, activation_by_pci_centre_ed_complete, activation_by_nonpci_centre_ed_iht_complete, activation_by_other_hospital_ward_at_pci_centre_complete, activation_by_other_hospital_ward_at_pci_centre_complete, rescue_pci_complete, pci_details_complete, lesion_1_complete, lesion_2_complete, lesion_3_complete, lesion_4_complete, lesion_5_complete, discharge_data_complete, day_data_complete) |>
  dplyr::rename() |>
