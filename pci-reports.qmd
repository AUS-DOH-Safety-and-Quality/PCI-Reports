...
#Required ordering for plotting
pci_data <- pci_data |> dplyr::arrange(period_end)
...
NCR1_spc <- controlcharts::spc(data = dplyr::filter(pci_data, NCR1_den == 1),
                   keys = period_end,
                   numerators = ecgdb,
                   denominators = NCR1_den,
                   aggregations = list(numerators = "median", denominators = "first"),
